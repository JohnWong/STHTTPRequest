...
- (void)startAsynchronous
{
    ...
    self.task = [self.session dataTaskWithRequest:request completionHandler:^(NSData *_Nullable data, NSURLResponse *_Nullable response, NSError *_Nullable error) {
        ...
        [strongSelf URLSession:strongSelf->_session dataTask:strongSelf->_task didReceiveResponse:response completionHandler:^(NSURLSessionResponseDisposition disposition) {
            
        }];
        [strongSelf dataTaskDidFinishLoading];
    }];
    [self.task resume];
